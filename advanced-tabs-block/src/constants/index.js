...
// prefix
export const PREFIX = 'atbs_';

// Responsive Devices
export const RES_DEVICES = [
    {
        label: __('Desktop', 'gutsliders'),
        value: 'Desktop',
        icon: (
...
export const FLEX_ALL = [
    ...
    {
        label: __('Justify', 'affiliaterg-block'),
        value: 'space-between',
        icon: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
...
export const COLORS = [
    {
        name: __('Orange', 'gutsliders'),
        color: '#ff9900'
    },
    {
        name: __('Yellow', 'gutsliders'),
        color: '#ffff00'
    },
    {
        name: __('Green', 'gutsliders'),
        color: '#00ff00'
    },
    {
        name: __('Blue', 'gutsliders'),
        color: '#0000ff'
    },
    {
        name: __('Purple', 'gutsliders'),
        color: '#9900ff'
    },
    {
        name: __('Black', 'gutsliders'),
        color: '#000000'
    }
];
...
export const BACKGROUND_TYPES = [
    {
        label: __('Classic', 'gutsliders'),
        value: 'classic'
    },
    {
        label: __('Gradient', 'gutsliders'),
        value: 'gradient'
    }
];
...
export const HEADING_TAGS = [
    {
        label: __('H1', 'gutsliders'),
        value: 'h1'
    },
    {
        label: __('H2', 'gutsliders'),
        value: 'h2'
    },
    {
        label: __('H3', 'gutsliders'),
        value: 'h3'
    },
    {
        label: __('H4', 'gutsliders'),
        value: 'h4'
    },
    {
        label: __('H5', 'gutsliders'),
        value: 'h5'
    },
    {
        label: __('H6', 'gutsliders'),
        value: 'h6'
    },
    {
        label: __('Div', 'gutsliders'),
        value: 'div'
    },
    {
        label: __('P', 'gutsliders'),
        value: 'p'
    },
    {
        label: __('Span', 'gutsliders'),
        value: 'span'
    }
];
...
export const ICON_TYPES = [
    {
        label: __('Icon Library', 'gutsliders'),
        value: 'iconLibrary'
    },
    {
        label: __('Custom SVG', 'gutsliders'),
        value: 'uploadSVG'
    }
];
