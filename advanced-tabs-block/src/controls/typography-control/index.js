...
import { BaseControl, ButtonGroup, Button, Flex, FlexBlock, FlexItem, Popover, RangeControl } from '@wordpress/components';
...
import { LHLS_UNITS, GENERAL_UNITS, PREFIX } from '../../constants';
...
//block constant
import { fontStyleOptions, fontWeightOptions, textTransformOptions, textDecorationOptions } from './constants';
            ...
            {typographyPanel && (
                ...
                >
                    <div className="gkits-typography-panel gkits-popover">
                        ...
                        <div className="gkits-mb-16">
                            <SelectControl
                                label={__('Font Weight', 'gutsliders')}
                                value={fontWeight}
                                options={fontWeights}
                                onChange={weight => {
                                    setAttributes({
                        ...
                        <div className="gkits-mb-16">
                            <SelectControl
                                label={__('Text Decoration', 'gutsliders')}
                            ...
                            <Flex align="flex-start">
                                <FlexBlock>
                                    <ResLabelControl
                                        ...
                                        label={__('Line Height', 'gutsliders')}
                                        requiredProps={{
                                            resMode,
                                            setAttributes
                                        }}
                            ...
                            <Flex align="flex-start">
                                <FlexBlock>
                                    <ResLabelControl
                                        ...
                                        label={__('Letter Spacing', 'gutsliders')}
                                        requiredProps={{
                                            resMode,
                                            setAttributes
                                        }}
